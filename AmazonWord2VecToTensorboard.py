    ...
    with open(os.path.join(output_path, meta_file), 'wb') as file_metadata:
        for i, word in enumerate(model.wv.index2word):
            ...
            if word == '':
                ...
                file_metadata.write("{0}".format(asin_title_dict[word]).encode('utf-8') + b'\n')
...
#  RUN python3 -m tensorboard.main --logdir=/Users/nmoguilner/Dev/ML/amazon-word2vec-api/static/data
